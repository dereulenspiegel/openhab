 ...
 * @since 1.4.0
 */
public class CULManagerImpl implements CULManager {

	private final static Logger logger = LoggerFactory.getLogger(CULManagerImpl.class);
	...
	public void activate() {
		logger.debug("CULManager activated");
	}

	public void deactivate() {
		logger.debug("CULManager deactivated");
	}
}
